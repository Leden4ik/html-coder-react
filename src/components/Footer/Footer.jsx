            ...
            <div className="hc__footer--box">
                <div className="hc__footer--menu">
                    ...
                    <div className="hc__footer--menu-box">
                        ...
                        <div className="hc__footer--menu-list">
                            <div className="hc__footer--menu-item">
                                <a className="hc__footer--menu-link" href="#" title="Express Delivery">Express Delivery</a>
                            </div>
                            <div className="hc__footer--menu-item">
                                <a className="hc__footer--menu-link" href="#" title="Privacy Statement">Privacy Statement</a>
                            </div>
                            <div className="hc__footer--menu-item">
                            ...
                            <div className="hc__footer--menu-item">
                                <a className="hc__footer--menu-link" href="#" title="Returns and Refunds">Returns and Refunds</a>
                            </div>
                            <div className="hc__footer--menu-item">
                            ...
                            <div className="hc__footer--menu-item">
                                <a className="hc__footer--menu-link" href="#" title="Returns and Orders">Returns and Orders</a>
                            </div>
                        </div>
                    </div>
                    <div className="hc__footer--menu-box">
                        ...
                        <div className="hc__footer--menu-list">
                            ...
                            <div className="hc__footer--menu-item">
                                <a className="hc__footer--menu-link hc-icon--phone-footer hc-icon--phone-footer-dims hc__footer--menu-phone" href="tel:+(844) 434-672">+(844) 434-672</a>
                            </div>
                        </div>
                    </div>
                </div>

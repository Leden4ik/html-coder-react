      ...
      <div className='hc__header--box'>
        ...
        <div className='hc__header--top'>
          <div className='hc__header--logo'>
            <a className='hc__header--logo-link' href='/' title='LOGO'>
              LOGO
            </a>
          </div>
          ...
          <div className='hc__header--menu'>
            <div className='hc__header--menu-list hc__header--menu-top'>
              <div className='hc__header--menu-item'>
                <a className='hc__header--menu-link' href='#' title='Request a Sample'>
                  Request a Sample
                </a>
              </div>
              <div className='hc__header--menu-item'>
                <a className='hc__header--menu-link' href='#' title='Help'>
                  Help
                </a>
              </div>
              <div className='hc__header--menu-item'>
                <a className='hc__header--menu-link' href='#' title='Contact'>
                  Contact
                </a>
              </div>
            </div>
        ...
        <div className='hc__header--nav'>
          <div className='hc__header--nav-list'>
            <div className='hc__header--nav-item'>
              <a className='hc__header--nav-link' href='#' title='Products'>
                Products
              </a>
            </div>
            <div className='hc__header--nav-item'>
              <a className='hc__header--nav-link' href='#' title='Resources'>
                Resources
              </a>
            </div>
            <div className='hc__header--nav-item'>
              <a className='hc__header--nav-link' href='#' title='Services'>
                Services
              </a>
            </div>
            <div className='hc__header--nav-item'>
              <a className='hc__header--nav-link' href='#' title='Locations'>
                Locations
              </a>
            </div>
            <div className='hc__header--nav-item'>
              <a className='hc__header--nav-link' href='#' title='Careers'>
                Careers
              </a>
            </div>
            <div className='hc__header--nav-item'>
              <a className='hc__header--nav-link' href='#' title='Support'>
                Support
              </a>
            </div>
